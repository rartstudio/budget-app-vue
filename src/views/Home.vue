<template>
  <div class="container mx-auto flex flex-col">
    <div class="w-full">
      <h2 class="text-center text-2xl mt-4 mb-8">Input Your Budget or Income</h2>
      <FormInput @formData="addData($event)" class="flex items-center flex-row justify-between"/>
    </div>
